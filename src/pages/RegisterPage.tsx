            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full bg-zinc-900 border border-zinc-800 pl-10 pr-4 py-3 text-white placeholder-gray-400 focus:ring-2 focus:ring-amber-500 focus:border-transparent rounded-lg"
